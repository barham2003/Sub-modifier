...
export function generateLines(
    ...
    let lines;
    if (type === ANIME_SERIES) {
        lines = [
            `زنــجـیـرەى ئەنیمێی ژێـرنـووسـکـراوی کـــوردی\\N{\\c&HFFFF00&}« ${name} »{\\c}`,
            `{\\c&HFFFF00&}${seriesInfo || ""}`,
        ...
        lines = [
            `زنــجـیـرەى ژێـرنـووسـکـراوی کـــوردی\\N{\\c&HFFFF00&}« ${name} »{\\c}`,
            `{\\c&HFFFF00&}${seriesInfo || ""}`,
            `وەرگـێـڕان\\N{\\c&HFFFF80&}${translator}{\\c}`,
            `تـەکـنـیـک\\N{\\c&HFFFF80&}${technique}{\\c}`,
            `مـافـی ئـەم بـەرهـەمـە و ژێـرنـووسـەکـەی پـارێزراوە بۆ ماڵـپـەڕی کـوردسـەبـتایـتڵ\\N{\\c&HFFFF80&}Www.KurdSubtitle.Net{\\c}`,
        ...
        lines = [
            `فـیـلـمی ژێـرنـووسـکـراوی کـوردی\\N{\\c&HFFFF80&} « ${name} »{\\c}`,
            `وەرگـێـڕان\\N{\\c&HFFFF80&}${translator}{\\c}`,
            `تـەکـنـیـک\\N{\\c&HFFFF80&}${technique}{\\c}`,
            `مـافـی ئـەم بـەرهـەمـە و ژێـرنـووسـەکـەی پـارێزراوە بۆ ماڵـپـەڕی کـوردسـەبـتایـتڵ\\N{\\c&HFFFF80&}Www.KurdSubtitle.Net{\\c}`,
        ];
...
export function generateHeader(type: string, topRightText: string) {
    if (type === ANIME_SERIES)
        return `
[Script Info]
...
Video File: ?dummy:23.976000:400000:1920:1080:27:63:90:
...
Style: Default,KSB_RABAR,115,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,-1,0,0,0,100,100,0,0,1,1.9,1.2,2,10,10,50,1
Style: Psht Rash,KSB_RABAR,89,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,3,1.4,0.8,2,10,10,40,1
Style: lay rast - 6,KSB_RABAR,70,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,1.4,0.8,6,10,10,10,1
Style: lay chap - 4,KSB_RABAR,70,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,1.4,0.8,4,10,10,10,1
Style: Tebenikan,KSB_RABAR,70,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,1.4,0.8,2,10,10,40,1
Style: tanya nawrast,KSB_RABAR,80,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,-1,0,0,0,100,100,0,0,1,1.2,0.7,5,10,10,40,1
Style: Logo Anime,KurdsubtitleAnime,20,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,2,2,2,10,10,10,1
Style: Subtitle,27_Sarchia_Blawkrawa_2,63,&H00FFFFFF,&H000000FF,&H00020713,&H00000000,-1,0,0,0,100,100,0,0,1,1.95,1.15,2,15,15,16,0
Style: Song,27_Sarchia_Blawkrawa_2,95,&H00FFFFFF,&H000000FF,&H00C20EC1,&H00000000,-1,0,0,0,100,100,0,0,1,4.5,0,8,15,15,30,0
Style: paper,Adobe Arabic,90,&H00FFFFFF,&H000000FF,&H00514EB5,&H00615FBE,-1,0,0,0,100,100,0,0,3,0,0.15,8,15,15,27,0
Style: P - Effect,27_Sarchia_Blawkrawa_2,65,&H00FFFFFF,&H000000FF,&H00675B17,&H00000000,-1,0,0,0,100,100,0,0,1,4.5,0,8,15,15,60,1
Style: P - lyrics2,27_Sarchia_Blawkrawa_2,65,&H00FFFFFF,&H000000FF,&H00675B17,&H00000000,-1,0,0,0,100,100,0,0,1,4.5,0,8,15,40,60,1
Style: Default سوچ,Segoe UI Symbol,32,&H00FFFFFF,&H000000FF,&H00000000,&H00000000,0,0,0,0,100,100,0,0,1,0.5,0.3,9,10,10,20,1
...
Dialogue: 0,0:00:00.00,1:06:06.00,Default سوچ,,0,0,0,,${topRightText}
Dialogue: 0,0:00:00.00,5:43:22.94,Logo Anime,,0,0,0,,{\\fnKurdsubtitleAnime\\fs100\\a4\\c&HFFFFFF&\\bord0.7\\shad1\\pos(49.333,25.067)}A
`;
    else
        return `
[Script Info]
...
[Events]
Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text
Dialogue: 0,0:00:00.00,3:33:33.33,Default سوچ,,0,0,0,,${topRightText}
...
export function generateMovedLogos(type: string) {
    if (type === MOVIE) return movieMovedLogos
    else if (type === SERIES) return seriesMovedLogs
    else return animeMovedLogos
...
const animeMovedLogos = `
Dialogue: 0,0:07:00.00,0:07:15.00,Logo Anime,,0,0,0,,{\\fs170\\fnKurdsubtitleAnime\\alpha&f7e&\\bord2\\shad0\\fad(800,800)\\move(1839.666,1006.778,43.667,50.777,7,15000)}A
Dialogue: 0,0:12:00.00,0:12:15.00,Logo Anime,,0,0,0,,{\\fs170\\fnKurdsubtitleAnime\\alpha&f7e&\\bord2\\shad0\\fad(800,800)\\move(1839.666,1006.778,43.667,50.777,7,15000)}A
Dialogue: 0,0:18:00.00,0:18:15.00,Logo Anime,,0,0,0,,{\\fs170\\fnKurdsubtitleAnime\\alpha&f7e&\\bord2\\shad0\\fad(800,800)\\move(1839.666,1006.778,43.667,50.777,7,15000)}A
Dialogue: 0,0:22:00.00,0:22:15.00,Logo Anime,,0,0,0,,{\\fs170\\fnKurdsubtitleAnime\\alpha&f7e&\\bord2\\shad0\\fad(800,800)\\move(1839.666,1006.778,43.667,50.777,7,15000)}A
`


const movieMovedLogos = `
